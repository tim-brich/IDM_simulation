...
def run_simulation_and_animate(params):
    ...
    annotations = [
        ax.text(0, -params['lane_width']/2 + 0.1, '', ha='center', va='bottom', fontsize=8, color='blue')
...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        vis_fr = ttk.LabelFrame(self, text='Параметры визуализации')
